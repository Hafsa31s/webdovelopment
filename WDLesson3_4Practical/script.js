function createStory(){
  ...
  let vegspan1 = document.getElementById("veg1");
  let vegspan2 = document.getElementById("veg2");
...
let boyName = document.getElementById("boyName").value;
  let vegetable1 = document.getElementById("veg1").value;
  let girlName = document.getElementById("girlName").value;
  let vegetable2 = document.getElementById("veg2").value;
  ...
  vegspan1.innerHTML = vegetable1;
  vegspan2.innerHTML = vegetable2;
